[![Build (Windows)](https://github.com/SAM-BIM/SAM_Psychrometrics/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/SAM-BIM/SAM_Psychrometrics/actions/workflows/build.yml)
...
**SAM_Psychrometrics** is part of the **SAM (Sustainable Analytical Model) Toolkit** —  
...
This repository provides **psychrometric calculation utilities**
used to evaluate moist air properties such as humidity ratio, enthalpy,
dew point temperature, and related thermodynamic quantities
within SAM analytical workflows.

The implementation is based on the **PsychroLib** reference library
and is intended to be used alongside the SAM core libraries
...
- Calculation of moist air thermodynamic properties
- Support for common psychrometric quantities used in building simulation
- Consistent integration with SAM analytical models
- Reference-backed calculations using **PsychroLib 2.5.0**
